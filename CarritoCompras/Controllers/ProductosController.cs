    ...
    public class ProductosController : OrigenController
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Codigo,Nombre,Modelo,Descripcion,Precio,CategoriaId,Stock,Disponible")] Producto producto)
        {
            ...
            var cat = await _context.Categorias
                .Where(cat => cat.CategoriaId == producto.CategoriaId)
                .FirstOrDefaultAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoId,Codigo,Modelo,Descripcion,Precio,CategoriaId,Stock,Disponible")] Producto producto)
        {
